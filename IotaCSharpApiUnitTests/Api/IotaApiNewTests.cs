...
namespace Iota.Lib.CSharpTests.Api
{
    ...
    public class IotaApiNewTests
    {
        ...
        private static string TEST_MILESTONE =
            "SMYMAKKPSUKCKDRUEYCGZJTYCZ9HHDMDUWBAPXARGURPQRHTAJDASRWMIDTPTBNDKDEFBUTBGGAFX9999";

        private static int TEST_MILESTONE_INDEX = 8059;
