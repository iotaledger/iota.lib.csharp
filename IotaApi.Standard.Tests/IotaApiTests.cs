...
namespace Iota.Api.Tests
{
    ...
    public class IotaApiTests
    {
        ...
        public void ShouldPrepareTransfer()
        {
            ...
            var trytes = _iotaClient.PrepareTransfers(TEST_SEED1, 2, transfers.ToArray(), null, null, null, false);
        ...
        public void ShouldPrepareTransferWithInputs()
        {
            ...
            List<string> trytes =
                _iotaClient.PrepareTransfers(TEST_SEED1, 2, transfers.ToArray(), null, inputlist.ToArray(), null, true);
        ...
        {
            var ftr = _iotaClient.FindTransactionObjectsByAddresses(TEST_ADDRESSES);
        ...
        {
            var gni = _iotaClient.GetNodeInfo();
            var ccr = _iotaClient.CheckConsistency(new[] {gni.LatestSolidSubtangleMilestone});
        ...
        {
            var replayedList = _iotaClient.ReplayBundle(TEST_HASH, DEPTH, MIN_WEIGHT_MAGNITUDE, null);
        ...
        {
            _iotaClient.SendTrytes(new[] {TEST_TRYTES}, DEPTH, MIN_WEIGHT_MAGNITUDE, null);
        }
        ...
        public void ShouldFailBeforeSnapshotTimeStamp()
        {
            try
            {
                ...
                Assert.Fail("Transaction did not fail on old timestamp value");
            }
        ...
        {
            _iotaClient.SendTrytes(new[] {TestTrytesValid}, DEPTH, MIN_WEIGHT_MAGNITUDE, null);
        }
        ...
        public void ShouldSendTransferWithoutInputs()
        {
            ...
            var str = _iotaClient.SendTransfer(TEST_SEED2, 2, DEPTH, MIN_WEIGHT_MAGNITUDE, transfers.ToArray(), null,
