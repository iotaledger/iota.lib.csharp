...
namespace Iota.MAM.Utils
{
    ...
    public class HammingNonce
    {
        ...
        public HammingNonce(CurlMode curlMode)
        {
        ...
        private bool SearchCpu(int[] state, int offset, int length,int security)
        {
        ...
        {
            int[] hash = new int[CurlHashLength];
        ...
        private void SearchPrepareTrits(int[] state, int offset)
        {
